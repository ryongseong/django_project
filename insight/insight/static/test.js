...
var q = {
    ...
    5: {"title": "밸런스 게임을 했을 때<br> 나의 생각은?","type": "SN", "A": "그딴 걸 왜함", "B": "히히히 재밌겠당"},
    6: {"title": "시험이 다가오는데 <br>공부가 손에 안잡힌다면?","type": "SN", "A": "지난 시험이 어떻게 나왔더라?", "B": "내가 왜 공부를 해야하지?"},
    7: {"title": "팀원이 나한테 '그쪽이랑 저랑 잘 <br>안맞네요'라고 했을 때 드는 생각은?","type": "TF", "A": "왜요?", "B": "흐흐흐흐흐그그그그그그ㅡ극ㄱ"},
    8: {"title": "슬픔을 둘로 나누면?","type": "TF", "A": "아아 스프스프스프!!", "B": "반이 된다"},
    9: {"title": "친구가 차 사고가 났다<br> 이때 나의 반응은?","type": "TF", "A": "과실 몇이야?", "B": "괜찮아...?"},
